...
struct ContentView: View {
    ...
    var body: some View {
        List(spaceList) { space in
            BasicImageList(space: space)
        }
        .listStyle(.plain)
    }
}
    ...
    var body: some View {
        VStack {
            ...
            Text(space.author)
             ...
             HStack {
                 ForEach(1...space.rating, id: \.self){ star in
